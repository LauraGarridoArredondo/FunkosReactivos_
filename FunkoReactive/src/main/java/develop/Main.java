...
/**
 * Clase principal que inicia la aplicacion y muestra ejemplos de uso de los servicios de Funkos.
 */
public class Main {
    /**
     * Metodo principal que inicia la aplicacion y muestra ejemplos de uso de los servicios de Funkos.
     *
     * @param args Los argumentos de la linea de comandos (no se utilizan en este caso).
     * @throws InterruptedException Si se produce un error de interrupcion.
     * @throws IOException Si se produce un error de E/S durante la importacion de datos.
     */
    public static void main(String[] args) throws InterruptedException, IOException {
        FunkosServiceImpl servicio = FunkosServiceImpl.getInstance(FunkosRepositoryImpl.getInstance(DatabaseManager.getInstance(),
                IdGenerator.getInstance()), FunkosNotificationImpl.getInstance(), FunkoStorageImpl.getInstance());
