...
/**
 * Implementacion concreta de un repositorio de Funkos que utiliza una base de datos y una fuente de generacion de IDs.
 * Proporciona metodos para realizar operaciones CRUD en entidades Funko en una base de datos.
 */
public class FunkosRepositoryImpl implements FunkosRepository {
     ...
     *
     * @param databaseManager El administrador de la base de datos.
     * @param idGenerator     El generador de identificadores unicos.
     */
    ...
    /**
     * Obtiene una instancia de FunkosRepositoryImpl, asegurando que sea una instancia unica.
     *
     * @param databaseManager El administrador de la base de datos.
     * @param idGenerator     El generador de identificadores unicos.
     * @return Una instancia de FunkosRepositoryImpl.
     */
