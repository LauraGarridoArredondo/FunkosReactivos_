...
/**
 * Clase de pruebas unitarias para FunkosRepositoryImpl.
 */
public class FunkosRepositoryImplTest {
    ...
    void updateFunko(){
        ...
        assertAll(() -> assertTrue(foundFunko.isPresent()),
                ...
                () -> assertNotEquals(savedFunko.getUpdatedAt(), foundFunko.get().getUpdatedAt()) // El updated tiene que ser diferente de la actual,
                // ya que se modifica automaticamente al llamar al update
        );
    }
